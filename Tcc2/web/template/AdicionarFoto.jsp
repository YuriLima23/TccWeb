                        ...
                        <div class="row">
                            <div class="col-md-9 ">
                                ...
                                <div class="col-md-7 animate-box">
                                    <h3>Album</h3>
                                    <form action="SiteCtl?acao=addFoto&id=${empregado.id}" method="Post"  enctype="multipart/form-data">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="descricao" id="message" cols="30" rows="10" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <input type="submit" value="Salvar Imagem" class="btn btn-primary">
                                        </div>
