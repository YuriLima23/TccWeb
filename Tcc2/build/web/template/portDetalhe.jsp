	...
	<div id="fh5co-author">
		<div class="container">
			<div class="row top-line animate-box">
                          	...
                          	<div class="col-md-6 " >
                                   <img src="../imagem/album.png" width="450" height="300" class="img-responsive" alt="Free HTML5 Template by FreeHTML5.co">
					...
					<p><a data-toggle="modal" data-target="#exampleModalCenter6" class="btn btn-primary">Adicionar Imagem</a></p>
				</div>
			</div>
		</div>
	</div>
