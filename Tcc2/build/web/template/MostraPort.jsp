			...
			<div class="fh5co-top-logo">
				<div class="portfolio-navigation">
						<div class="col-xs-4 text-right">
							<a  href="SiteCtl?acao=perfilCandidato&id=${empregado.id}" class="btn btn-primary btn-outline"><i class="icon-chevron-left"></i> Voltar </a>
						</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 text-center animate-box">
					<a class="work" href="SiteCtl?acao=verFotoEmpregador&idFoto=${obj.id}&idEmpregado=${empregado.id}">
