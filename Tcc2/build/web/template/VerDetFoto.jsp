                    ...
                    <div class="fh5co-top-logo">
                        <div class="portfolio-navigation">
                            <div class="col-xs-4 text-right">
                                <a  href="SiteCtl?acao=listarFotosEmpregador&id=${empregado.id}" class="btn btn-primary btn-outline"><i class="icon-chevron-left"></i> Voltar </a>
                            </div>
            ...
            <div id="fh5co-author">
                <div class="container">
                    <div class="row top-line animate-box">
                        ...
                        <div class="col-md-6 " >
                            <img src="../imagem/${foto.fotos}" width="500" height="300" class="img-responsive" alt="Free HTML5 Template by FreeHTML5.co">
