...
<div class="page-content" >
    <div>
        ...
        <div class="section" id="skill">
            <div class="container">
                <div class="h4 text-center mb-4 title">Avaliação Média</div>
                    ...
                    <div class="tab-pane active" id="web-development">
                        <div class="ml-auto mr-auto">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="SiteCtl?acao=listarFotosEmpregador&id=${empregado.id}">
                    ...
                    <div class="row" >
                        <c:forEach items="${listaContratos}" var="obj">
                                ...
                                <div class="col-md-9" data-aos="fade-left"  data-aos-offset="50" data-aos-duration="500">
                                    ...
                                    <a style="float: right; margin-right: 30px; " class="btn btn-danger"  data-aos="zoom-in" data-aos-anchor="data-aos-anchor">
